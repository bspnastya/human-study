...
if not st.session_state.name:
    st.markdown("<div style='color:#111;'><h2>Уважаемый участник,<br>добро пожаловать!</h2><p>Введите псевдоним или нажмите «Сгенерировать».</p></div>",unsafe_allow_html=True)
...
if st.session_state.phase=="intro":
    intro_c="Сейчас вы увидите изображение. Нужно сравнить диагональные углы и сказать, одинаковый ли цвет."
    intro_l="Сейчас вы увидите изображение. Нужно указать, видите ли вы русские буквы."
