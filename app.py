...
if not st.session_state.name:
   ...
   <div style="color:#111;">
       ...
       <p>
       <b>Пожалуйста, проходите тест спокойно: исследование не направлено на оценку испытуемых.
       Оценивается работа алгоритмов, которые выдают картинки разного качества.</b>
       </p>
...
if st.session_state.phase == "intro":
   ...
   if current_idx < 5:
       ...
       if st.button("Перейти к вопросу", key=f"proceed_{current_idx}"):
           st.session_state.phase = "question"
           st.session_state.phase_start_time = None
           st.rerun()
   else:
       intro_duration = INTRO_TIME_REST
