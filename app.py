...
CORNER_ANS = {"img1_dif_corners":"нет","img2_dif_corners":"нет",
              "img3_same_corners_no_symb":"да","img4_same_corners":"да",
              "img5_same_corners":"да"}
LETTER_ANS = {"img1_dif_corners":"ж","img2_dif_corners":"фя",
...
""",
    ...
    nm = st.text_input("", placeholder="Фамилия / псевдоним",
...
Сейчас вы увидите изображение. Цель — посмотреть на
<b>правый верхний и левый нижний</b> углы и определить,
окрашены ли они в один цвет.<br><br>
Картинка будет доступна <b>15 секунд</b>. Время на ответ не ограничено.
</div>""",
            unsafe_allow_html=True,
        )
    else:
